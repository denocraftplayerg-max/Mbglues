// QUANNEGGAES4D - config/stats.h
// Copyright (c) 2025-2026 MobileGL-Dev
// Licensed under the GNU Lesser General Public License v2.1:
//   https://www.gnu.org/licenses/old-licenses/lgpl-2.1.txt
// SPDX-License-Identifier: LGPL-2.1-only
// End of Source File Header
#ifndef _QUANNEGGAES4D_STATS_H_
#define _QUANNEGGAES4D_STATS_H_
...
extern "C"
{
    ...
    // what a game actually loads: one dlopen of libQUANNEGGAES4D.so is one launch,
    ...
    //
    // Only counts when QNG_COUNT_LAUNCH is set, and the launchers set it through
