...
> Please visit [QUANNEGGAES4D-release](https://github.com/MobileGL-Dev/QUANNEGGAES4D-release) to get the latest stable release.

Please see [QUANNEGGAES4D](https://github.com/MobileGL-Dev/QUANNEGGAES4D) and [QUANNEGGAES4D-release](https://github.com/MobileGL-Dev/QUANNEGGAES4D-release) to get more information.

License
====
QUANNEGGAES4D is licensed under **GNU LGPL-2.1 License**.

Please see [LICENSE](https://github.com/MobileGL-Dev/Quanneggaes4d-plugin/blob/main/LICENSE).

Third party components
====
For the components used by the renderer itself, please see [QUANNEGGAES4D-release](https://github.com/MobileGL-Dev/QUANNEGGAES4D-release).
...
```bash
apksigner verify --print-certs path/to/Quanneggaes4d-plugin.apk
```
