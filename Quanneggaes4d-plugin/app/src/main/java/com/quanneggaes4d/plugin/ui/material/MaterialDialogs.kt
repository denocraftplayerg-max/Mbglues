...
import com.quanneggaes4d.plugin.ui.Responsive
import com.quanneggaes4d.plugin.ui.AuthPrompt
import com.quanneggaes4d.plugin.ui.Farewell
import com.quanneggaes4d.plugin.ui.PrivacySections
import com.quanneggaes4d.plugin.ui.LinkEntry
import com.quanneggaes4d.plugin.ui.SponsorChannels
import com.quanneggaes4d.plugin.ui.sourceRepositories
import com.quanneggaes4d.plugin.ui.SponsorPromptState
...
fun MaterialDialogHost(controller: AppController) {
    ...
    if (resetPrompt) {
        ResetDialog(
            ...
            onRemove = controller::removeQUANNEGGAES4D,
            onDismiss = controller::dismissResetPrompt,
        )
    }

    if (removing) ProgressDialog(text = stringResource(R.string.removing_quanneggaes4d))
...
/** 不可取消的进度对话框（移除 QUANNEGGAES4D 期间）。 */
@Composable
