...
internal object QNGConfigCodec {
    ...
    fun decode(root: JsonObject): QNGConfig {
        val defaults = QNGConfig.Default
        return QNGConfig(
    ...
    fun encode(config: QNGConfig, foreignKeys: JsonObject?): JsonObject =
