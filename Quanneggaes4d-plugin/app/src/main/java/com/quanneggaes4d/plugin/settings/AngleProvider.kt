 ...
 * 找出设备上谁能借 ANGLE 给我们。
 *
 * ANGLE 不在本 App 里——它随启动器分发，QUANNEGGAES4D 在游戏进程里能直接 dlopen 到它，
 * 是因为那时候进程属于启动器。本 App 自己 dlopen 渲染器跑分时没有这个便利：
 * [com.quanneggaes4d.plugin.settings.AngleProvider] 就是用来补上这一段的。
 *
...
object AngleProvider {
     ...
     * QUANNEGGAES4D 会一半走 ANGLE 一半走系统驱动，比干脆用不了还糟。
     */
