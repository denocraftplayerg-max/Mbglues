...
val SponsorChannels = listOf(
    LinkEntry("爱发电 · QUANNEGGAES4D", "https://afdian.com/a/QUANNEGGAES4D"),
...
fun sourceRepositories(): List<LinkEntry> = listOf(
    LinkEntry(
        ...
        "https://github.com/MobileGL-Dev/QUANNEGGAES4D-release",
    ),
    LinkEntry(
        stringResource(R.string.repo_renderer),
        "https://github.com/MobileGL-Dev/QUANNEGGAES4D",
    ),
    LinkEntry(
        stringResource(R.string.repo_plugin),
        "https://github.com/MobileGL-Dev/Quanneggaes4d-plugin",
    ),
)
