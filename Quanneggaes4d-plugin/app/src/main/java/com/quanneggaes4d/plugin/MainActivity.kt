...
import com.quanneggaes4d.plugin.ui.AuthFlowLauncher
import com.quanneggaes4d.plugin.ui.QUANNEGGAES4DApp
...
class MainActivity : ComponentActivity(), AuthFlowLauncher {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        controller = AppController(application as QNGApplication, this, this)
        setContent { QUANNEGGAES4DApp(controller) }
    ...
    override fun onStop() {
        ...
        (application as QNGApplication).configStore.flushAsync()
    }
