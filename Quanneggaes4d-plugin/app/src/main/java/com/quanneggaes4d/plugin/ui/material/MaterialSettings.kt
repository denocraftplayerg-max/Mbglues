...
package com.quanneggaes4d.plugin.ui.material
...
import com.quanneggaes4d.plugin.settings.SpinnerOption
import com.quanneggaes4d.plugin.settings.UiStyle
import com.quanneggaes4d.plugin.ui.AppController
import com.quanneggaes4d.plugin.ui.SettingsLoadState
        ...
        Crossfade(
            ...
            Column(modifier = Modifier.fillMaxWidth()) {
                when {
                    ...
                    ready -> ConfigSections(controller, config ?: QNGConfig.Default)
...
@Composable
private fun ConfigSections(controller: AppController, config: QNGConfig) {
 ...
 */
@Composable
private fun GlslCacheSlider(controller: AppController, config: QNGConfig, totalRamBytes: Long?) {
