...
struct MGQueryCapability {
    bool HasQUANNEGGAES4DExt = false; // GL_QNG_quanneggaes4d
    bool BackendStringGetterAccess = false; // GL_QNG_backend_string_getter_access
    bool SettingsStringDump = false; // GL_QNG_settings_string_dump
}g_MGQueryCapability;